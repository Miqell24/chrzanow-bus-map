#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Cuts data/osm/chrzanow.json (the roads) out of the Geofabrik malopolskie and
...
ROAD_BOX = (50.00, 19.18, 50.26, 19.62)   # S, W, N, E — every commune the union serves
...
road_file = os.path.join(ROOT, 'data/osm/chrzanow.json')
